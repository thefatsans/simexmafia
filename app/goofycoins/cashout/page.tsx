...
export default function GoofyCoinsCashoutPage() {
  const router = useRouter()
  const { user, isLoading, isAuthenticated, updateUser, syncUserFromDatabase } = useAuth()
  ...
  const [requests, setRequests] = useState<GoofyCoinCashoutRequest[]>([])
