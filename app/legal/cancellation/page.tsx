...
export default function CancellationPage() {
  const { email } = companyInfo.contact
        ...
        <div className="bg-fortnite-dark border border-purple-500/20 rounded-lg p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-300">
              Um Ihr Widerrufsrecht auszuüben, müssen Sie uns ({companyInfo.legalName},{' '}
              {getFullAddress()}, E-Mail:{' '}
          ...
          <section>
            ...
            <div className="bg-fortnite-darker border border-purple-500/30 rounded-lg p-6">
              <p className="text-gray-300 mb-4">
                Wenn Sie den Vertrag widerrufen möchten, dann füllen Sie bitte dieses Formular aus und senden Sie es
                zurück an:
              </p>
              <div className="text-gray-300 space-y-1 mb-4">
                <p>
                  <strong className="text-white">{companyInfo.legalName}</strong>
                </p>
                <p>{address.street}</p>
                <p>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-2">Das Widerrufsrecht besteht nicht bei Verträgen:</p>
          ...
          <section>
            ...
            <p className="text-gray-300">Bei Fragen zum Widerruf können Sie uns jederzeit kontaktieren:</p>
