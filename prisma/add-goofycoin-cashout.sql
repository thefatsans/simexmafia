-- GoofyCoin cashout requests (Bargeld / Echtgeld)
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'GoofyCoinCashout_userId_fkey'
  ) THEN
    ALTER TABLE "GoofyCoinCashout"
      ADD CONSTRAINT "GoofyCoinCashout_userId_fkey"
